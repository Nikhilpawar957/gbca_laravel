    ...
    <div
        ...
        <div style="width: 100%;">
            <h3
                ...
                Thank you</h3>
            <div class="row">
                <p style="padding: 0px 10px 0px 20px; margin-bottom: 0px;font-size: 15px;">Hello <b>Team</b>,
                </p>
                <p style="padding: 0px 10px 0px 20px; margin-bottom: 0px;font-size: 15px;">You got a new user signup.
                </p>
            </div>
            <div class="row">
                <div>
