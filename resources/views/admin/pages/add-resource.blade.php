...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Add Resource | ' . env('APP_NAME'))
@section('content')
                ...
                <div class="card-body border-bottom py-3">
                    <div class="row row-cards">
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                <label for="resource_short_desc" class="form-label required">Resource Short
                                    Description</label>
                                <textarea class="form-control" id="resource_short_desc" name="resource_short_desc" rows="4"></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control ckeditor" id="resource_desc" name="resource_desc" rows="10"></textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                <img id="image-previewer" src="https://placehold.co/600x400" class="img-fluid"
                                    alt="">
                            </div>
                            <div class="mb-3">
